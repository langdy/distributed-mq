...
public class SerializeConfig {
    ...
    public final ObjectSerializer createJavaBeanSerializer(Class<?> clazz) {
        SerializeBeanInfo beanInfo =
                TypeUtils.buildBeanInfo(clazz, null, propertyNamingStrategy, fieldBased);
    ...
    public void config(Class<?> clazz, SerializerFeature feature, boolean value) {
        ...
        if (serializer == null) {
            SerializeBeanInfo beanInfo =
                    TypeUtils.buildBeanInfo(clazz, null, propertyNamingStrategy);
        ...
        if (writer == null) {
            ...
            if (Map.class.isAssignableFrom(clazz)) {
                ...
                if (className.startsWith("java.awt.") //
                    ...
                    if (!awtError) {
                        try {
                            String[] names = new String[] {"java.awt.Color", "java.awt.Font",
                    ...
                    try {
                        {
                            String[] names = new String[] {"java.time.LocalDateTime",
                                    ...
                                    "java.time.OffsetTime", "java.time.ZoneOffset",
                                    "java.time.ZoneRegion", "java.time.Period",
                        ...
                        {
                            String[] names =
                                    new String[] {"java.util.Optional", "java.util.OptionalDouble",
