 ...
 * this deserializer through {@link ParserConfig#putDeserializer(Type, ObjectDeserializer)}.
 * </p>
 * 
 * <pre>
 ...
 * 
 * <pre>
 * ParserConfig.getGlobalInstance().putDeserializer(OrderActionEnum.class,
 *         new OrderActionEnumDeser());
 * </pre>
 */
public interface ObjectDeserializer {
    /**
     * fastjson invokes this call-back method during deserialization when it encounters a field of
     * the specified type.
     * <p>
     * In the implementation of this call-back method, you should consider invoking
     * {@link JSON#parseObject(String, Type, Feature[])} method to create objects for any
     * non-trivial field of the returned object.
     *
