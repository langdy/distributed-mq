...
public class ActivemqPools {
     ...
     * 多集群连接池集合
     */
    private static List<ActivemqPoolFactory> pools =
            new CopyOnWriteArrayList<ActivemqPoolFactory>();
    ...
    private static void initPools() {
        ...
        for (ConnectionConfig config : configs) {
            ...
            if (maximumActiveSessionPerConnection == null
                    || maximumActiveSessionPerConnection <= 0) {
                maximumActiveSessionPerConnection =
                        BaseConstant.DEFAULT_MAXIMUM_ACTIVE_SESSION_PER_CONNECTION;
            }
