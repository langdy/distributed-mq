...
public class HttpClientUtil {
	 ...
	 * @throws Exception
	 */
	public static String doGet(String url, Map<String, String> querys, Map<String, String> headers) throws Exception {
	 ...
	 * @throws Exception
	 */
	public static String doPost(String url, List<NameValuePair> parameters, Map<String, String> headers)
			throws Exception {
		HttpClient client = HttpClients.createDefault();// 创建HttpClient对象
	...
	public static void main(String[] args) throws Exception {
		...
		List<ConnectionConfig> configs =
				JSON.parseObject(text.toJSONString(), new TypeReference<List<ConnectionConfig>>() {});
