...
public class TestConsumer {
	...
	public void queue() throws InterruptedException {
		...
		Consumer.receiveQueueMessage("deal-details-queue-demo?consumer.exclusive=true", new MessageListener() {
			@Override
	...
	public void topic() throws InterruptedException {
		// consumer.exclusive=true代表独家消费者
		Consumer.receiveTopicMessage("deal-details-topic-demo?consumer.exclusive=true", "aadd", new MessageListener() {
			@Override
			public void onMessage(Message message) {
				try {
